...
const LANGUAGE_SPECS = [
    ...
    { title: 'انگلیسی', code: 'en', direction: 'ltr', classes: ['formal', 'informal'], src: true, tgt: true, codePointRegex: /[A-Za-z\u0080-\u00fe\u0100-\u017e\u0180-\u024e\u1e00-\u1efe\u2c60-\u2c7e\ua720-\ua7fe]/g },
...
class LangAuto {
    ...
    get availableClasses() { return this.detected.classes || null }
...
class TypeAuto {
    constructor(triggerChangesItem) {
        ...
        this.code2type = {};
        this.src = this.tgt = true;
        for (let type of TYPE_SPECS)
            this.code2type[type.code] = type;
    }
...
class Translation {
    ...
    translate(text, direction, class_) {
        ...
        return TargomanAPI.translate(
            'ssid', text, direction, '', 'NMT', true, true, true, this.lastTUID, class_
        ).then(data => {
